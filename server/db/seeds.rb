...
users.first.wishes.create!([{ available_offline: false,
                              available_online: true, goal: 'Code real good',
                              programminglanguage: python_lang,
                              meetinginterval: weekly_meet }])
users.second.wishes.create!([{ available_offline: true,
                               available_online: true, goal: 'Get smarter',
                               programminglanguage: python_lang,
                               meetinginterval: daily_meet }])
users.first.wishes.create!([{ available_offline: false,
                              available_online: true, goal: 'Code really well in Python',
                              programminglanguage: scala_lang,
                              meetinginterval: weekly_meet }])

users.second.experiences.create!([{ available_offline: true,
                                    available_online: true,
                                    qualification: 'Help students learn',
                                    programminglanguage: python_lang,
                                    meetinginterval: daily_meet }])
